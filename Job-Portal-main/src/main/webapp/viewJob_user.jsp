...
<div class="contentMain">
    ...
    <div class="content">
        ...
        <form action="searchJobView.jsp" method="get">
            ...
            <div class="job-form">
                ...
                </select> <label for="category">Category of Job : </label> <select
                    id="cat" name="cat">
    ...
    %>
        ...
        <div class="job-field">
            <label>View More</label> <span> <%=j.getStatus()%>
            </span>
        </div>
        ...
        <a href="https://www.google.com/about/careers/applications/" class="buttons"><button
...
<script>
    // Get all buttons with the class 'viewMore'
    var buttons = document.querySelectorAll('.viewMore');
    
    // Loop through each button
    buttons.forEach(function(button) {
        // Add click event listener to each button
        button.addEventListener('click', function() {
            // Redirect to the URL specified in the button's href attribute
            window.location.href = 'https://www.cricbuzz.com/'; // Change the URL as needed
        });
    });
</script>
</body>
